...
import { CasaOSClient } from './casaos-client.js';
const config = {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        ...
        if (name === 'casaos_deploy_app') {
            const { appId, title, icon, webPort, category, composeYaml } = args;
